...
$(function() {
	...
	$(".file").change(function() {
		...
		//var imgNum = 1; // 上传的图片数
		var imgNum = parseInt($(this).attr("imgNum"));
		...
		if(fileList.length > imgNum || totalNum > imgNum) {
			...
			for(var i = 0; i < fileList.length; i++) {
				...
				imgArr.push(imgUrl);
				var $section = $("<section class='up-section fl loading' style='display:none'>");
				...
				$("#"+imgId).attr("src", imgArr[i]);
				
				$("#"+imgId+"_a").attr("href", imgArr[i]);
				$("#"+imgId+"_enlarge").attr("src", imgArr[i]);
