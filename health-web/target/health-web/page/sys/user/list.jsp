...
<head>
<meta charset="UTF-8">
<title data-localize="user.title">用户管理</title>
<!-- 导入共通样式页面 -->
		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
				    ...
				    <li class="active" style="color:#00c9ef">用户管理</li>
				</ul>
				<!-- /.breadcrumb -->
            </div>
					...
					<div class="col-lg-12">
							...
							<div class="panel-body">
								<form id="formSearch" class="form-horizontal">
									<div class="form-group">
										<!-- 搜索条件 -->
										<label class="control-label col-sm-1" data-localize="user.loginname">用户名</label>
										<div class="col-sm-2">
											<input type="text" class="form-control" id="search_loginname" maxlength="20">
										</div>
										<label class="control-label col-sm-1" data-localize="user.realname">昵称</label>
										<div class="col-sm-2">
						...
						<div id="toolbar" class="btn-group">
							<p>
								...
								&nbsp;&nbsp;
								<button type="button" class="btn btn-sm" onclick="batchOff();">
									<i class="fa fa-lock"></i> <span data-localize="button.batchOff">批量停用</span>
								</button>
							</p>
						</div>
						<!-- 加载列表 -->
