...
<head>
<meta charset="UTF-8">
<title data-localize="role.title">角色权限</title>
<!-- 导入共通样式页面 -->
		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
				    ...
				    <li class="active" style="color:#00c9ef">角色权限</li>
				</ul>
				<!-- /.breadcrumb -->
            </div>
							...
							<div class="panel-body">
								<form id="formSearch" class="form-horizontal">
									<div class="form-group">
										...
										<!-- 搜索条件 -->
										<label class="control-label col-sm-1" data-localize="role.name">名称</label>
										<div class="col-sm-2">
