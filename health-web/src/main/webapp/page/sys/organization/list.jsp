...
<head>
<meta charset="UTF-8">
<title data-localize="organization.title">机构管理</title>
<!-- 导入共通样式页面 -->
		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
				    ...
				    <li class="active" style="color:#00c9ef">机构管理</li>
				</ul>
				<!-- /.breadcrumb -->
            </div>
							...
							<div class="panel-body">
								<form id="formSearch" class="form-horizontal">
									<div class="form-group">
										<!-- 搜索条件 -->
										<label class="control-label col-sm-1" data-localize="organization.orgName">机构名称</label>
										<div class="col-sm-2">
											<input type="text" class="form-control" id="search_orgName" maxlength="20">
										</div>
										
										<label class="control-label col-sm-1" data-localize="organization.orgId">机构编号</label>
										<div class="col-sm-2">
											<input type="text" class="form-control" id="search_orgId" maxlength="20">
										</div>
										
										<label class="control-label col-sm-1" data-localize="organization.orgPhone">机构电话</label>
										<div class="col-sm-2">
											<input type="text" class="form-control" id="search_orgPhone" maxlength="20">
										</div>
										
										<label class="control-label col-sm-1" data-localize="organization.linkman">联系人</label>
										<div class="col-sm-2">
											<input type="text" class="form-control" id="search_linkman" maxlength="20">
										</div>

									</div>
									
									<div class="form-group">
										<label class="control-label col-sm-1" data-localize="common.updatetime">更新时间</label>
										<div class="col-sm-2">
