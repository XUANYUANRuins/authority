...
import cn.ffcs.shiro.CustomShiroSessionDAO;
import cn.ffcs.shiro.login.UserOnlineBo;
...
public class CustomSessionManager {
	...
	public UserOnlineBo getSessionBo(Session session){
		...
		if(obj instanceof SimplePrincipalCollection){
			...
			if(null != obj && obj instanceof TbUser){
				//存储session + user 综合信息
				UserOnlineBo userBo = new UserOnlineBo((TbUser)obj);
				//最后一次和系统交互的时间
